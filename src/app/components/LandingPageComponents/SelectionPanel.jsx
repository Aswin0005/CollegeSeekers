...
function SelectionPanel() {
  ...
  return (
    <div className="relative w-full bg-amber-400 p-4">
      ...
      <div
        ref={scrollRef}
        className="flex overflow-x-auto space-x-6 scrollbar-hide gap-12 items-center"
      >
        {/* Individual Buttons */}
        <button className="px-6 py-2 ml-4 bg-slate-400 text-black whitespace-nowrap ">
          Engineering
        </button>
        <button className="px-6 py-2 bg-slate-400 text-black whitespace-nowrap ">
          Medical
        </button>
        <button className="px-6 py-2 bg-slate-400 text-black whitespace-nowrap ">
          Law
