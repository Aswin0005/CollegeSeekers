  ...
  return (
    <>
      <div className="md:hidden bg-white px-4 py-6 space-y-4">
        ...
        <button className="bg-[#2914B5] w-full  text-white px-6 py-3 mr-6 rounded-md hover:bg-yellow-600 flex items-center justify-center ">
          Get Started
        </button>
        <button className="w-full  text-white px-6 py-3 mr-6 rounded-md bg-yellow-500 flex items-center justify-center ">
          Book Councelling
        </button>
      </div>
      <section
        className="relative h-[50vh] md:h-screen bg-cover bg-center text-slate-950 flex flex-col justify-center"
        style={{ backgroundImage: 'url(/bg1.png)' }}
      >
        {/* Top layer with black transparent background */}
        <div className="hidden md:absolute top-0 left-0 right-0 bg-black bg-opacity-60 z-10 p-4">
        ...
        <div className="absolute  left-4 md:left-16 top-14 md:top-1/2 transform md:-translate-y-1/2 text-center md:text-left z-10 flex flex-col-reverse md:flex-col gap-6">
          <h3 className="text-lg md:text-xl font-medium text-white text-left">
            Shaping Sustainable Futures,
          </h3>
          <h1 className="text-2xl max-sm:w-64 md:text-4xl lg:text-5xl font-bold text-white text-left">
            Discover Colleges Based on Your Unique Path
          </h1>
          <button className="bg-blue-600 px-6 py-3 rounded-md hover:bg-blue-700 transition-all duration-300 text-white hidden md:flex items-center w-40 space-x-2 ">
