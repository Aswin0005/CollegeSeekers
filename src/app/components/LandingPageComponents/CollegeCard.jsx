    ...
    return (
      <div className="max-w-sm mx-auto bg-white shadow-lg rounded-lg overflow-hidden border border-gray-200">
        <div className="bg-purple-100 p-4 flex justify-between items-center">
          <div>
            <h2 className="text-lg font-bold text-gray-900">Top Colleges - 2024</h2>
            <p className="text-sm text-gray-600">Top Engineering Colleges in India</p>
          </div>
        ...
        <div className="p-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <p className="font-medium text-gray-900">Indian Institute Of Technology - Chennai</p>
            </div>
          ...
          <div className="mt-3">
            ...
            <div className="flex items-center justify-between py-1">
              <div className="flex items-center">
                ...
                <span className="ml-2 text-gray-700">Average Salary - 12 LPA</span>
              </div>
            </div>
