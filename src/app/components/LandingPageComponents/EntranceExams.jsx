...
export default function EntranceExams() {
    return (
      <div className="max-w-sm mx-auto bg-white shadow-lg rounded-lg overflow-hidden border border-gray-200 flex flex-col justify-between">
        <div className="bg-purple-100 p-4 flex justify-between items-center">
          <div>
            ...
            <p className="text-sm text-gray-600">Entrance Exams in Engineering Colleges</p>
          </div>
        ...
        <div className="p-4 grid grid-cols-3 gap-2 ">
          {["JEE Main", "JEE Advanced", "BITSAT", "VITEEE", "SRMJEEE", "WBJEE", "COMEDK UGET", "MHT CET", "KIITEE"].map((exam) => (
            <button
              key={exam}
